          ...
          <Container>
            ...
            <div style={{ margin: "50px 0" }}>
              <Accordion TransitionProps={{ unmountOnExit: true }}>
                ...
                <AccordionDetails>
                  <Typography>
                    With most issues you encounter in the course of using
                    Google, be it a problem with your Gmail, your Google Chrome
                    browser, or Google Maps, other people have likely
                    encountered and documented the same issues a dozen times
                    over.
                  </Typography>
                </AccordionDetails>
              </Accordion>
